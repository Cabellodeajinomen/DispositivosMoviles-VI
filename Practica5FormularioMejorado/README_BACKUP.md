...
- Componentes: RadioButton para género, Checkbox para términos, Switch para estado activo, Slider para nivel.
...
- Botón "Limpiar" que reinicia todos los campos.
...
2. Seleccionar género, marcar términos.
3. El botón se habilita automáticamente cuando todo es válido.
